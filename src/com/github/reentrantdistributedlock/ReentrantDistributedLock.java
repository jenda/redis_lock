 ...
 * regular java locks.
 * 
 * The current implementation is guarded by expiring keys so it cannot never
 * deadlock forever in case of disappearing lock holder.
 * 
 * If lock is to be held for a longer period of time, it's important to keep
